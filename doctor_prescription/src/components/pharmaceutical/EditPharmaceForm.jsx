...
function EditPharmaceForm(props) {
  const [formData, setFormData] = useState({
    id: props.editingData._id,
    name: props.editingData.name,
    category: props.editingData.category,
    dose: props.editingData.dose,
    doseCount: props.editingData.doseCount,
    intaketime: props.editingData.intaketime,
    manufactoy: props.editingData.manufactoy,
    description: props.editingData.description,
    anotherIntaketime: props.editingData.anotherIntaketime,
  });
...
export default EditPharmaceForm;
