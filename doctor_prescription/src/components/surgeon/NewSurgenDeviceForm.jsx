...
function NewSurgenDeviceForm(props) {
  ...
  useEffect(() => {
    if (props.type === "edit") {
      setFormData({
        ...
        manufacureName: props.data.manufacureName,
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        id="outlined-required"
        size="small"
        value={formData.manufacureName}
        onChange={(event) =>
          handleInputChange("manufacureName", event.target.value)
        } // Update the name state
        sx={{
          width: "100%",
          direction: "rtl",
...
export default NewSurgenDeviceForm;
