...
function PartientsProfile({
  ...
  return (
      <div className={`bg-white fixed z-[50]   left-[50%] top-[50%] overflow-scroll h-[80%]  transform translate-x-[-50%] translate-y-[-50%] ${screenMode ? 'w-full min-h-screen' : 'w-11/12 max-w-7xl mx-auto my-8'}  rounded-lg shadow-xl`}>
